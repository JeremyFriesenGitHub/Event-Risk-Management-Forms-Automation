...
exports.scheduleInPerson = scheduleInPerson;
...
function scheduleInPerson(PRIMARY_FIRST_NAME, PRIMARY_LAST_NAME, PRIMARY_CARLETON_ID, PRIMARY_EMAIL, PRIMARY_PHONE, SECONDARY_FIRST_NAME, SECONDARY_LAST_NAME, SECONDARY_CARLETON_ID, SECONDARY_EMAIL, SECONDARY_PHONE, EVENT_TITLE, EVENT_DATE, EVENT_START_TIME, EVENT_END_TIME, EVENT_DESCRIPTION, EVENT_LOCATION, EVENT_EXPECTED_ATTENDEES, RISK_SPEAKER_TOPICS, RISK_SPEAKER_FULL_NAMES, RISK_SPEAKER_WEBSITE_URL, EMERGENCY_SAFETY_CONCERNS, EMERGENCY_SAFETY_RISKS, LOGISTICS_CLEANUP_PEOPLE, LOGISTICS_SAFETY_CONCENRS) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 22:
                    _a.sent();
                    return [4 /*yield*/, formLayout.fillRightsTextBox(LOGISTICS_SAFETY_CONCENRS)
