...
(async function getInputAndRunPlaywright() {
    ...
    answers.EVENT_TITLE, answers.EVENT_DATE, answers.EVENT_START_TIME, answers.EVENT_END_TIME, 
    answers.EVENT_DESCRIPTION, answers.EVENT_LOCATION, answers.EVENT_EXPECTED_ATTENDEES, 
    answers.ONLINE_PLATFORM, answers.ONLINE_TOPICS, answers.ONLINE_LOCATION, answers.ONLINE_ORGANIZERS, 
    answers.ONLINE_ORGANIZERS_ATTENDENCE_FROM_ORIGIN, answers.RISK_SPEAKER_TOPICS, 
    'Raef Sarofiem, Ajaan Nalliah', 'https://cuhacking.ca/', 'None', 'None', 'The organizers', 'None'
  )
})()