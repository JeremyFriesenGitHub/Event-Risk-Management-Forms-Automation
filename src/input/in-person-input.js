    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    answers = _a.sent();
                    return [4 /*yield*/, (0, in_person_1.scheduleInPerson)('Raef', 'Sarofiem', '101266475', 'raefsarofiem@cmail.carleton.ca', 'RAEF_PHONE_NUMBER', 'Ajaan', 'Nalliah', '101325463', 'ajaannalliah@cmail.carleton.ca', '6478773250', answers.EVENT_TITLE, answers.EVENT_DATE, answers.EVENT_START_TIME, answers.EVENT_END_TIME, answers.EVENT_DESCRIPTION, answers.EVENT_LOCATION, answers.EVENT_EXPECTED_ATTENDEES, answers.RISK_SPEAKER_TOPICS, 'Raef Sarofiem, Ajaan Nalliah', 'https://cuhacking.ca/', 'None', 'None', 'The organizers', 'None')];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
