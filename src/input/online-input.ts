...
(async function getInputAndRunPlaywright() {
  ...
  await scheduleOnline(
    ...
    answers.EVENT_DESCRIPTION, answers.EVENT_EXPECTED_ATTENDEES, answers.ONLINE_PLATFORM, 
    answers.ONLINE_TOPICS, answers.ONLINE_LOCATION, answers.ONLINE_ORGANIZERS, 
